...
export const eventos: Evento[] = [
  ...
  // },
  descripcionImg: {
    imagen: "/images/eventos/cartelNeil.jpeg",
  }, 
  descripcion6: {
    es: "<span style=\"color:var(--color-principal)\">Un evento 100 % benéfico</span><br></br><p><span style=\"color:var(--color-principal)\">La recaudación íntegra</span> de todos los conciertos será destinada a <span style=\"color:var(--color-principal)\">asociaciones y colectivos que trabajan activamente con personas en situación de vulnerabilidad</span>, ya sea física, mental o social. Esta acción busca <span style=\"color:var(--color-principal)\">fortalecer su labor</span>, darles visibilidad y generar un impacto positivo directo.</p>",
    en: "<span style=\"color:var(--color-principal)\">A 100 % charity event</span><br></br><p><span style=\"color:var(--color-principal)\">All proceeds</span> from all concerts will be destined for <span style=\"color:var(--color-principal)\">associations and groups working actively with vulnerable people</span>, whether physically, mentally or socially disadvantaged. This initiative seeks to <span style=\"color:var(--color-principal)\">strengthen their work</span>, raise visibility and generate a direct positive impact.</p>",
    fr: "<span style=\"color:var(--color-principal)\">Un événement 100 % caritatif</span><br></br><p><span style=\"color:var(--color-principal)\">L’ensemble des recettes</span> de tous les concerts sera destiné à <span style=\"color:var(--color-principal)\">des associations et groupes œuvrant activement auprès de personnes vulnérables</span>, sur les plans physique, mental ou social. Cette action vise à <span style=\"color:var(--color-principal)\">renforcer leur travail</span>, à augmenter leur visibilité et à générer un impact positif direct.</p>",
    de: "<span style=\"color:var(--color-principal)\">Ein zu 100 % gemeinnütziges Event</span><br></br><p><span style=\"color:var(--color-principal)\">Der gesamte Erlös</span> aller Konzerte geht an <span style=\"color:var(--color-principal)\">Vereine und Initiativen, die aktiv mit schutzbedürftigen Menschen arbeiten</span>, sei es körperlich, psychisch oder sozial benachteiligt. Diese Aktion zielt darauf ab, ihre Arbeit zu <span style=\"color:var(--color-principal)\">stärken</span>, ihre Sichtbarkeit zu erhöhen und eine direkte positive Wirkung zu erzeugen.</p>",
  },
  descripcion7: {
