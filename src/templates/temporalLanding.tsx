...
import { useTranslation } from 'react-i18next'
  ...
  export default function TemporalLanding() {
    const { t , ready} = useTranslation('temporalLanding');
    if (!ready) return null;
    return (
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 min-h-screen flex justify-center">
        <img
          alt=""
